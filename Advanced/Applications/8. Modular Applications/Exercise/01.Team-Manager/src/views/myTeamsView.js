import { getMyTeams } from "../data/teams.js";
  ...
  <section id="my-teams">
    ...
    <article class="layout narrow">
      <div class="pad-med">
        ...
        <p><a href="#">Browse all teams</a> to join one, or use the button bellow to cerate your own team.</p>
      </div>
...
export async function showMyTeamView() {
    ...
    const myTeams = await getMyTeams("34a1cab1-81f1-47e5-aec3-ab6c9810efe1");
    console.log(myTeams);
    render(myTeamTemplate());
}